...
class BoardControllerTest {
    ...
    public void updateCallTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/boards/{boardId}",responseDto.getId())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    private void saveMember() {
        BoardCreationDto boardCreationDto = new BoardCreationDto("title","content");
        responseDto = boardService.saveBoard(boardCreationDto);
    }
    ...
    public void lookUpOneCallTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/boards/{boardId}", responseDto.getId()))
                .andDo(print())
